...
menuScene.create = function(){
    ...
    this.title = this.add.image(320, 180, 'title');
    this.button = this.add.image(320, 280, 'button');
...
pauseScene.create = function(){
    this.titleBG = this.add.image(320, 180, 'titleBG');
    this.button = this.add.image(320, 180, 'button');
...
gameScene1.create = function(){
    ...
    range = this.physics.add.sprite(100, 260, 'range').setVisible(false), this.physics.add.sprite(540, 220, 'range').setVisible(false);
    tower = this.physics.add.sprite(100, 260, 'tower'), this.physics.add.sprite(540, 220, 'tower');
    enemy = this.physics.add.sprite(100, 260, 'archer'), this.physics.add.sprite(540, 220, 'archer');
...
gameScene2.create = function(){
    ...
    tower = this.physics.add.sprite(380, 140, 'tower');
    tower2 = this.physics.add.sprite(260, 220, 'tower2');
    cannon = this.physics.add.sprite(260, 220, 'cannon');
    enemy = this.physics.add.sprite(380, 140, 'archer');
...
function enemyFire(enemy, player, time, gameObject){
    ...
    if ((time - enemy.lastFired) > 1000 && Phaser.Geom.Intersects.RectangleToRectangle(this.player.getBounds(), this.range.getBounds()))
    {
        ...
        if (bullet)
        {
            ...
            //gameObject.physics.add.collider(ai1, bullet, ai1HitCallback);
        }
    }
}
